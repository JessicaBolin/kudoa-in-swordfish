# Prepare rasters of distance to EAC and extract distances (Part II - BRAN)
...
setwd("/EAC") #path to where eac_bran/EAC is stored
...
mean(total$dist_core) #[1] 315.8122
sd(total$dist_core) #[1] 211.0527
median(total$dist_core) #[1] 242.313
range(total$dist_core) #[1]  36.28056 752.02954

saveRDS(total, "distances_to_core_best_method_BRAN.RDS") #not available in repo
